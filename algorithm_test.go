...
func TestFullySpecifiedAlgorithmValues(t *testing.T) {
	tests := []struct {
		alg  Algorithm
		want int64
	}{
		...
		{AlgorithmESP384, -51},
		{AlgorithmESP512, -52},
		{AlgorithmEd25519EdDSA, -19},
	}
	for _, tt := range tests {
		t.Run(tt.alg.String(), func(t *testing.T) {
			if got := int64(tt.alg); got != tt.want {
				t.Errorf("Algorithm value = %d, want %d", got, tt.want)
			}
		})
	}
}
...
func TestAlgorithm_hashFunc(t *testing.T) {
	tests := []struct {
		...
		{AlgorithmESP256, crypto.SHA256},
		{AlgorithmES384, crypto.SHA384},
		{AlgorithmESP384, crypto.SHA384},
		{AlgorithmES512, crypto.SHA512},
		{AlgorithmESP512, crypto.SHA512},
		{AlgorithmEdDSA, 0},
		{AlgorithmEd25519EdDSA, 0},
		{AlgorithmReserved, 0},
